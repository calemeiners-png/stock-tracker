...
const styles = {
  ...
  layout: { display: "flex", flex: 1, overflow: "hidden", flexDirection: window.innerWidth <= 768 ? "column" : "row" },
  leftPanel: { width: "240px", minWidth: "180px", borderRight: "1px solid #1e293b", overflowY: "auto", padding: "0.5rem 0" },
